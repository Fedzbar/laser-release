...
from laser.loss.subtoken_prediction_loss import subtoken_cross_entropy
from laser.utils import cfg_to_dict, flatten_dict, make_wandb_name

from .custom_train_utils import freeze_attention_weights
...
def custom_train(loggers, loaders, model, optimizer, scheduler, run):
    """
    ...
    for cur_epoch in range(start_epoch, cfg.optim.max_epoch):
        if cfg.dynamic.aggregation == "attention":
            freeze_attention_weights(model, cur_epoch)
