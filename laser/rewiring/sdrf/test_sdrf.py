import pytest
from .sdrf import SDRFTransform
...
class TestTransform:
    ...
    def test_snapshot_implementation(self):
        ...
        one_snapshot = SDRFTransform(num_snapshots=1, num_iterations=num_iterations)
        two_snapshot = SDRFTransform(num_snapshots=2, num_iterations=num_iterations)
